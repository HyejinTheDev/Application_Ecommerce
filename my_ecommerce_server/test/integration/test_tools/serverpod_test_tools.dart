...
import 'package:serverpod_auth_core_server/serverpod_auth_core_server.dart'
    as _i4;
import 'package:my_ecommerce_server/src/generated/greetings/greeting.dart'
    as _i5;
import 'package:my_ecommerce_server/src/generated/product.dart' as _i6;
import 'package:my_ecommerce_server/src/generated/protocol.dart';
import 'package:my_ecommerce_server/src/generated/endpoints.dart';
...
class _ProductEndpoint {
  ...
  _i3.Future<void> addSampleProduct(
    _i1.TestSessionBuilder sessionBuilder,
    _i6.Product product,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'product',
            method: 'addSampleProduct',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'product',
          methodName: 'addSampleProduct',
